...
The following default directions must be considered:

- <span style={{ color: "#8ca3ff" }}>**Tension (+)**</span>
  - <span style={{ color: "#8ca3ff" }}>**Correspondence (+)**</span>
  - <span style={{ color: "#8ca3ff" }}>**Chirality (+)**</span>
  - <span style={{ color: "#263578" }}>**Closure (-)**</span>
    - <span style={{ color: "#263578" }}>**Depth (-)**</span>
    - <span style={{ color: "#263578" }}>**Cadence (-)**</span>
...
establishing the conditions to allow for further contributions.
...
flowchart TD
  ...
  classDef committalNode fill:#edf2ff,stroke:#748ffc,color:#748ffc
  classDef transNode fill:transparent

  class EMPTY transNode
  class O,C1 committalNode

  style E fill:transparent,stroke:#8ca3ff,stroke-width:2px
  style S fill:transparent,stroke:#263578,stroke-width:2px
```
...
that allows for _new_ contributions. It is derived directly from the magnitude of Tension:
...
It encapsulates the flow of Propositions from generation to commitment within a single Domain.
...
flowchart TD
  ...
  subgraph S[Settlement]
    ...
    subgraph CH2["Context Horizon 2"]
        ...
        E1("Exp #1<br/>T: +1.00 · LC: 0.00<br/>Origin Influence: -1.00")
        E2("Exp #2<br/>T: +0.75 · LC: 0.25<br/>Origin Influence: -0.25")
        C1("Com #1<br/>T: +0.75 · GC: 0.25<br/>Origin Influence: -0.11")
    end
  end
  ...
  subgraph E[Emergence]
    ...
    subgraph CH3["Context Horizon 3"]
        ...
        E3("Exp #3<br/>T: +0.50 · LC: 0.50<br/>Origin Influence: -0.06")
    end
