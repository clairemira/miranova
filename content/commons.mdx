...
If a stable and balanced state is centered in the middle,
...
Tension defaulted positive (+), as the average of (+, +, -)
from Correspondence, Chirality, and Closure respectively.

## Bootstrapping

The bootstrapping process demonstrates how a substrate is created,
while simultaneously allocating all available Charge.
...
- The Origin then gets written into Canon:
  ...
  - The Origin's Tension flips and is recorded as `-1`.
  - A Closure boundary is reached and the Context Horizon is closed off in Emergence.
  - The Origin's active Domain then shifts to Settlement.
- The system is now in a state of maximum Tension, but that can be reduced with the
  very next contribution in Settlement.
- Reducing Tension is the equivalent of reclaiming Charge.
